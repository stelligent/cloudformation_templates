    ...
    <tr>
        <td colspan="2">
            <table>
                ...
                <tr>
                    <td>
                    <code>aws cloudformation create-stack --profile stelligent-dev --stack-name "stelligent-dev-rdsbacked-webapp" --template-url "https://s3.amazonaws.com/stelligent-public-cloudformation-templates/github/webapp/autoscaling-bakedami-rdsbackend.template" --parameters file:///Users/username/aws/cloudformation_parameters/stelligent-dev-rdsbacked-webapp.json</code>
                    </td>
                </tr>
                <tr>
                    <td>
    ...
    <tr>
        <td colspan="2">
            <table>
                ...
                <tr>
                    <td>
                    <code>aws cloudformation create-stack --profile stelligent-dev --stack-name "stelligent-dev-webapp" --template-url "https://s3.amazonaws.com/stelligent-public-cloudformation-templates/github/webapp/autoscaling-bakedami.template" --parameters file:///Users/username/aws/cloudformation_parameters/stelligent-dev-webapp.json</code>
                    </td>
                </tr>
                <tr>
                    <td>
